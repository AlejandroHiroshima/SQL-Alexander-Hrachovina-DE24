...
SELECT
	CASE 
		WHEN 
		employment_type = 'CT' THEN 'Contract'
...
SELECT salary_sek_monthly, salary_sek_yearly FROM main.cleaned_salaries;
...
summarize main.cleaned_salaries; -- OBS, GER BRA ÖVERBLICK
...
--F
-- chhose columns: experience_level, employment_type, job_title, salary_annual_sek, salary_monthly_sek, remote_ratio, company_size, salary_level
